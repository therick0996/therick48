...
/* FN
  ...
  |-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------|
  |           |  Qwerty   |   Game    |           |   MAKE    |           |           |   Home    |   Pg Dn   |   Pg Up   |    End    |           |
  |-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------|
  |           |           |           |           |   Enter   |           |           |           |           |           |           |           |
  '-----------------------------------------------------------------------------------------------------------------------------------------------'
*/
  ...
  [_FN] = LAYOUT_ortho_4x12(
    ...
    _______,    TG(0),      TG(6),      _______,    MAKE,       _______,    _______,    CTL_HOME,   SFT_PGDN,   SFT_PGUP,   CTL_END,    _______,
...
*/
  ...
  [_GAME] = LAYOUT_ortho_4x12(
    ...
    KC_LCTL,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_SPC,     KC_SPC,     KC_M,       KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT
  )
